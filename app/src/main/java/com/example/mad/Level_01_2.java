...
public class Level_01_2 extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_01_2);
        ...
        lowerImageView[0] = (ImageView) findViewById(R.id.imgNum_15);
        lowerImageView[1] = (ImageView) findViewById(R.id.imgNum_9);
        ...
        int lowerImages[][] = {
                {R.drawable.n15, R.drawable.n9, R.drawable.n8, R.drawable.n12, R.drawable.n18}
        };
        ...
        for (int i = 0; i < lowerImages[gameValue - 1].length; i++) {
            ...
            lowerImageView[i].setOnTouchListener(new Level_01_2.MyTouchListener());
        ...
        if (fl1 != null) {
            fl1.setOnDragListener(new Level_01_2.MyDragListener());
        ...
        if (flBox != null) {
            flBox.setOnDragListener(new Level_01_2.MyDragListener2());

        }

        upperImageViews.setOnDragListener(new Level_01_2.MyDragListener2());
        ...
        public boolean onDrag(View v, DragEvent event) {
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    iv.setTag(letrval);
                    iv.setOnTouchListener(new Level_01_2.MyNextTouchListener());
        ...
        public boolean onDrag(View v, DragEvent event) {
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.imgNum_15) {
                        Toast.makeText(Level_01_2.this, "15", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(Level_01_2.this, "9", Toast.LENGTH_SHORT).show();
                        upperImageViews.setImageResource(R.drawable.box);
                        iScore = iScore + 2;
                    } else if (view.getId() == R.id.imgNum_8) {
                        Toast.makeText(Level_01_2.this, "8", Toast.LENGTH_SHORT).show();
