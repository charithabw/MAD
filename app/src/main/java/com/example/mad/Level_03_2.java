...
public class Level_03_2 extends AppCompatActivity implements SensorEventListener {
    ...
    private static String iLevel = "3_2";
    private static String prviLevel = "3_1";
    ...
    public void startTimer() {
        countDownTimer = new CountDownTimer(timeLeftInMilliSeconds, 1000) {
            ...
            public void onFinish() {
                Toast.makeText(Level_03_2.this, "Times gone", Toast.LENGTH_SHORT).show();
                AlertDialog.Builder builder = new AlertDialog.Builder(Level_03_2.this);
                builder.setMessage("Do you want to Submit !!!").setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
    ...
    public void updateData() {
        ...
        try{
            ...
            if(data >0 ){
                ...
                Toast.makeText(Level_03_2.this, "Invalid", Toast.LENGTH_SHORT).show();
            }}catch (Exception e){
    ...
    public void getAllInfo() {
        ...
        try {
            ...
            if (cursor.getCount() == 0) {
                Toast.makeText(Level_03_2.this, "Data Not Found", Toast.LENGTH_SHORT).show();
                showMassages("Error", "Data not Found!!!");
                return;
            } else {


                Toast.makeText(Level_03_2.this, "Data Found", Toast.LENGTH_SHORT).show();
