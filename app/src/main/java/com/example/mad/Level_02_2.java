...
public class Level_02_2 extends AppCompatActivity implements SensorEventListener {
    ...
    private static String iLevel = "2_2";
    private static String prviLevel = "2_1";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_02_2);
        ...
        int lowerImages[][] = {
                {R.drawable.n16, R.drawable.n24, R.drawable.n36, R.drawable.n9, R.drawable.n15}
        };
        ...
        for (int i = 0; i < lowerImages[gameValue - 1].length; i++) {
            ...
            lowerImageView[i].setOnTouchListener(new Level_02_2.MyTouchListener());
        ...
        if (fl1 != null) {
            fl1.setOnDragListener(new Level_02_2.MyDragListener());
        ...
        if (flBox != null) {
            flBox.setOnDragListener(new Level_02_2.MyDragListener2());

        }

        upperImageViews.setOnDragListener(new Level_02_2.MyDragListener2());

        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Level_02_2.this);
...
//        });
        ...
        public void startTimer() {
            countDownTimer = new CountDownTimer(timeLeftInMilliSeconds, 1000) {
                ...
                public void onFinish() {
                    Toast.makeText(Level_02_2.this, "Times gone", Toast.LENGTH_SHORT).show();
                    AlertDialog.Builder builder = new AlertDialog.Builder(Level_02_2.this);
                    builder.setMessage("Do you want to Submit !!!").setCancelable(false).setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            .setNegativeButton("No", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    Intent intent = new Intent(getApplicationContext(), Level_02_2.class);
                                    startActivity(intent);
                                    dialogInterface.cancel();
                                    //finish();
        ...
        public boolean onDrag(View v, DragEvent event) {
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    iv.setTag(letrval);
                    iv.setOnTouchListener(new Level_02_2.MyNextTouchListener());
        ...
        public boolean onDrag(View v, DragEvent event) {
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if (view.getId() == R.id.imgNum_16) {
                        Toast.makeText(Level_02_2.this, "16", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(Level_02_2.this, "24", Toast.LENGTH_SHORT).show();
                        upperImageViews.setImageResource(R.drawable.box);
                        iScore = iScore + 2;
                    } else if (view.getId() == R.id.imgNum_36) {
                        Toast.makeText(Level_02_2.this, "36", Toast.LENGTH_SHORT).show();
                        upperImageViews.setImageResource(R.drawable.box);
                        iScore = iScore + 2;

                    } else if (view.getId() == R.id.imgNum_9) {
                        Toast.makeText(Level_02_2.this, "9", Toast.LENGTH_SHORT).show();
                        upperImageViews.setImageResource(R.drawable.redbox);
                        iScore = iScore - 2;
                    } else if (view.getId() == R.id.imgNum_15) {
                        Toast.makeText(Level_02_2.this, "15", Toast.LENGTH_SHORT).show();
                        upperImageViews.setImageResource(R.drawable.redbox);
                        iScore = iScore - 2;
                    }
                    score.setText(String.valueOf(iScore));
    ...
    public void updateData() {
        ...
        try{
            ...
            if(data >0 ){
                Toast.makeText(Level_02_2.this, "Success", Toast.LENGTH_SHORT).show();
            }
            else{
                Toast.makeText(Level_02_2.this, "Invalid", Toast.LENGTH_SHORT).show();
            }}catch (Exception e){
    ...
    public void getAllInfo() {
        try {
            ...
            if (cursor.getCount() == 0) {
                Toast.makeText(Level_02_2.this, "Data Not Found", Toast.LENGTH_SHORT).show();
                showMassages("Error", "Data not Found!!!");
                return;
            } else {
                Toast.makeText(Level_02_2.this, "Data Found", Toast.LENGTH_SHORT).show();
